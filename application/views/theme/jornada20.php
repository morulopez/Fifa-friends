  ...
  <div class="row">
    <div class="col-md-12" id="resulusuarios">
     ...
     <p id="info">
        ...
        <input type="hidden" id="estadoco" value="<?php echo $estado_cobros[4]['cobro'];?>">
        <?php
        if($logueado==4){ 
        if($estado_cobros[4]["estado"]==false){?>
         <button type="submit" onclick="Ajax.cobros();">Generar cobros</button><br><br>
        <?php } ?>
        <?php
        if($jornada[19]["estado"]==false){ ?>
       ...
       <input type="hidden" id="local1" class="equiposv" value="<?php echo $enfrentamientos[19]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal1">  <input type="hidden" class="resul" id="resultadovisitante1"> <input type="hidden" class="equiposv" id="visitante1" value="<?php echo $enfrentamientos[0]['nombre_equipo']; ?>">
        <input type="hidden" id="local2"  class="equiposv" value="<?php echo $enfrentamientos[18]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal2" > <input type="hidden" class="resul" id="resultadovisitante2"> <input type="hidden" class="equiposv" id="visitante2" value="<?php echo $enfrentamientos[1]['nombre_equipo']; ?>">
         <input type="hidden" id="local3" class="equiposv" value="<?php echo $enfrentamientos[17]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal3" >   <input type="hidden" class="resul" id="resultadovisitante3"> <input type="hidden" id="visitante3" class="equiposv" value="<?php echo $enfrentamientos[2]['nombre_equipo']; ?>">
          <input type="hidden" id="local4" class="equiposv" value="<?php echo $enfrentamientos[16]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal4" >  <input type="hidden" class="resul" id="resultadovisitante4"> <input type="hidden" id="visitante4" class="equiposv" value="<?php echo $enfrentamientos[3]['nombre_equipo']; ?>">
           <input type="hidden" class="equiposv" id="local5" value="<?php echo $enfrentamientos[15]['nombre_equipo']; ?>"> <input type="hidden"  class="resul" id="resultadolocal5" >  <input type="hidden" class="resul" id="resultadovisitante5"> <input type="hidden" class="equiposv" id="visitante5" value="<?php echo $enfrentamientos[4]['nombre_equipo']; ?>">
            <input type="hidden" id="local6" class="equiposv" value="<?php echo $enfrentamientos[14]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal6" >  <input type="hidden" class="resul" id="resultadovisitante6"> <input type="hidden" id="visitante6" class="equiposv" value="<?php echo $enfrentamientos[5]['nombre_equipo']; ?>">
             <input type="hidden" class="equiposv" id="local7" value="<?php echo $enfrentamientos[13]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal7" >  <input type="hidden" class="resul" id="resultadovisitante7"> <input type="hidden" class="equiposv" id="visitante7" value="<?php echo $enfrentamientos[6]['nombre_equipo']; ?>">
              <input type="hidden" class="equiposv" id="local8" value="<?php echo $enfrentamientos[12]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal8" >   <input type="hidden" class="resul" id="resultadovisitante8"> <input type="hidden" class="equiposv" id="visitante8" value="<?php echo $enfrentamientos[7]['nombre_equipo']; ?>">
               <input type="hidden" class="equiposv" id="local9" value="<?php echo $enfrentamientos[11]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal9" >   <input type="hidden" class="resul" id="resultadovisitante9"> <input type="hidden" class="equiposv" id="visitante9" value="<?php echo $enfrentamientos[8]['nombre_equipo']; ?>">
                <input type="hidden" class="equiposv" id="local10" value="<?php echo $enfrentamientos[10]['nombre_equipo']; ?>"> <input type="hidden" class="resul" id="resultadolocal10" >  
                 <input type="hidden" class="resul" id="resultadovisitante10"> <input type="hidden" class="equiposv" id="visitante10" value="<?php echo $enfrentamientos[9]['nombre_equipo']; ?>">
...
<?php
        ...
        <tr>
          <td><input type="text" id="rlocal1" class="equiposv" value="<?php echo $enfrentamientos[19]['nombre_equipo']; ?>" readonly></td>
         ...
         <tr>
          <td><input type="text" id="rlocal2" class="equiposv colorresul" value="<?php echo $enfrentamientos[18]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv colorresul" id="rvisitante1" value="<?php echo $enfrentamientos[1]['nombre_equipo']; ?>" readonly></td>
        </tr>

         <tr>
          <td><input type="text" id="rlocal3" class="equiposv" value="<?php echo $enfrentamientos[17]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv" id="rvisitante3" value="<?php echo $enfrentamientos[2]['nombre_equipo']; ?>" readonly></td>
        </tr>

         <tr>
          <td><input type="text" id="rlocal4" class="equiposv colorresul" value="<?php echo $enfrentamientos[16]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv colorresul" id="rvisitante4" value="<?php echo $enfrentamientos[3]['nombre_equipo']; ?>" readonly></td>
        </tr>

         <tr>
          <td><input type="text" id="rlocal5" class="equiposv" value="<?php echo $enfrentamientos[15]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv" id="rvisitante5" value="<?php echo $enfrentamientos[4]['nombre_equipo']; ?>" readonly></td>
        </tr>

         <tr>
          <td><input type="text" id="rlocal6" class="equiposv colorresul" value="<?php echo $enfrentamientos[14]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv colorresul" id="rvisitante6" value="<?php echo $enfrentamientos[5]['nombre_equipo']; ?>" readonly></td>
        </tr>

         <tr>
          <td><input type="text" id="rlocal7" class="equiposv" value="<?php echo $enfrentamientos[13]['nombre_equipo']; ?>" readonly></td>
         ...
         <tr>
          <td><input type="text" id="rlocal8" class="equiposv colorresul" value="<?php echo $enfrentamientos[12]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv colorresul" id="rvisitante8" value="<?php echo $enfrentamientos[7]['nombre_equipo']; ?>" readonly></td>
        </tr>

         <tr>
          <td><input type="text" id="rlocal9" class="equiposv" value="<?php echo $enfrentamientos[11]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv" id="rvisitante9" value="<?php echo $enfrentamientos[8]['nombre_equipo']; ?>" readonly></td>
        </tr>

         <tr>
          <td><input type="text" id="rlocal10" class="equiposv colorresul" value="<?php echo $enfrentamientos[10]['nombre_equipo']; ?>" readonly></td>
          ...
          <td><input type="text" class="equiposv colorresul" id="rvisitante10" value="<?php echo $enfrentamientos[9]['nombre_equipo']; ?>" readonly></td>
        </tr>
      </table>
